...
@Component({
  ...
  template: `
    <div class="bg-surface border border-border-base p-8 md:p-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 transition-colors duration-300 shadow-sm">
      ...
      <button class="shrink-0 flex items-center gap-2 bg-accent hover:bg-accent-hover text-background px-6 py-3.5 text-sm font-bold uppercase tracking-wider transition-colors shadow-glow focus:outline-none">
